...
interface NavProfileContentProps {
    nftContractList: any;
    nftMetadata: any;
    trendingData: any;
...
const NavProfileContent: NextPage<NavProfileContentProps> = ({
    nftContractList,
    nftMetadata,
    trendingData,
    stakedNftCountList,
                                                    ...
                                                    <div className="col-xl-3 col-lg-3 col-md-4 col-sm-6 col-xs-6 mb-60" key={key}>
                                                        <div className="t-card">
                                                            ...
                                                            <div className="stake-btn mt-20">
                                                                <button className="cmn-btn-1 h-48 f-18 radius-12 w-100" onClick={() => { onUnstake(contract_id, nftData.token_id) }}>
                                                                    <span>Unstake</span>
                                                                </button>
                                                            </div>
                                                        </div>
